...
LibNetwork 是 Docker 对 CNM 一种实现。它其中包含一系列本地驱动
...
``` bash
$ docker run -it --network=host --name=<container> <image:tag>
```
...
services:
  <service>:
    ...
    # 注意：当 network_mode 为 host 时，'ports' 指令会被忽略！
    # ports
    ## - 9300:9300
    ## - 9304:9304
```

NOTE: windows 系统 docker-desktop 需要手动开启 Settings-Resources-Network: Enable host networking
