...
美元的贬值将持续增加资本利得(资产相对升值)，而持续降低劳动所得(汇率降低，购买力降低)，它将继续扩大贫富分化的水平，它将使美国的所有的矛盾进一步激化


#### SWIFT

目前 SWIFT 大概是 200 多个国家都在用它。这回它之所以可以用这个工
具来收拾香港，甚至来收拾中国，是因为目前美元的结算系统依旧是覆盖全球，
并且非常强大。它之所以有能力，就是使用这样一个工具，就是因为它确实是，
依旧是非常强大。就是美元的这个霸权，就是通过 SWIFT 来作为一种架构，
摆在这里的。整个这个架构的时间长度，差不多 80 年呢（80 年的时间长度）；所以它非常稳固，而且牢靠，是建立于战争之后的，战后的架构。
